...
void EdgeModel::createOBJproFrame(vector<Line3D> lines3DproFrame,int frame_nr) {
...
void EdgeModel::createOBJgrouped(vector<Line3D> grouped_lines) {
    ...
    char filename_lines[200];
    sprintf(filename_lines,"/Users/irina/Develop/workspace/bachelor_1/data/3Dlines_approx.obj");
    QFile file (filename_lines);
